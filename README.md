# 📊 Data Analytics Portfolio | Pedro Gonçalves

Bem-vindo ao meu hub de projetos em análise de dados. Este espaço documenta minha evolução técnica e minha capacidade de transformar dados brutos em insights estratégicos. Aqui, você encontrará soluções práticas organizadas por tecnologia, refletindo minha trajetória na construção de decisões baseadas em dados.
...
| [🗄️ SQL](./sql) | Scripts de extração de dados e estruturação de bancos. Principais ferramentas: PostgreSQL, MySQL, ETL. 
| [📊 Power BI](./power-bi) | Dashboards interativos e relatórios de inteligência de negócio.
| [📗 Excel](./excel) | Modelagem de dados, planilhas inteligentes e dashboards rápidos. 
